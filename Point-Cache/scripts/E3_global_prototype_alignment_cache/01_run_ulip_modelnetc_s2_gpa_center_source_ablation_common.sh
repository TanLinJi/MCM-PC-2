...
if [[ "$#" -lt 5 ]]; then
  echo "Usage: bash 01_run_ulip_modelnetc_s2_gpa_center_source_ablation_common.sh EXP_ID RUNNER PROMPT_SOURCE METHOD_FULL PURPOSE [GPU]"
  echo
  echo "This common script is for E3 center-source ablation:"
  echo "  Center-B: Entropy-only center"
  echo "  Center-C: Entropy+GPA union center"
  exit 1
fi
...
echo "============================================================"
echo "E3 Center Source Ablation"
