...
if [[ "$#" -lt 4 ]]; then
  echo "Usage: bash 00_run_ulip_modelnetc_s2_gpa_common.sh EXP_ID PROMPT_SOURCE METHOD_FULL PURPOSE [GPU]"
  echo
  echo "PROMPT_SOURCE choices:"
  echo "  manual_full"
...
echo "============================================================"
echo "E3 Global Prototype-Alignment Cache"
...
python runners/E3_global_prototype_alignment_cache/run_e3_ulip_modelnetc_s2_gpa.py \
