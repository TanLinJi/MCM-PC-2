...
export E4_GPA_GLOBAL_GAMMAS="${E4_GPA_GLOBAL_GAMMAS:-${GPA_GLOBAL_GAMMAS:-0.1,0.25,0.5}}"

mkdir -p "${WANDB_DIR}"

echo "============================================================"
echo "E4-C-A0-c2 Z-score Accepted-History Text-Visual GPA Cache Prior-Corrected GPA Global Logits"
echo "EXP_ID: ${EXP_ID}"
echo "RUNNER: ${RUNNER}"
...
echo "E4_GPA_GLOBAL_GAMMAS: ${E4_GPA_GLOBAL_GAMMAS}"
echo "============================================================"
