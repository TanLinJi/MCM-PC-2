...
run_combo() {
  ...
  echo "================================================------------"
  echo "09_2 OpenShape ScanObjNN-C all35 explicit final-score evaluation"
  echo "GPU: ${PHYSICAL_GPU}"
  echo "SONN_VARIANT: ${SONN_VARIANT}"
  echo "Setting: ${setting}"
  echo "E4_FINAL_SCORE_WEIGHTS: ${E4_FINAL_SCORE_WEIGHTS}"
  echo "Result dir:"
  echo "/root/autodl-tmp/MCM-PC-2/Point-Cache/results/E4_distribution_guided_cache/09_2_${setting}_${E4_FINAL_SCORE_SWEEP_TAG}_openshape_scanobjnnc_${SONN_VARIANT}_all35_zs_global_local_e4_c_a0_e1_explicit_final_score_tw0p15_score_norm_manual_full_clip_manualfull_llm_dynamic_init_textdist"
  echo "================================================------------"
