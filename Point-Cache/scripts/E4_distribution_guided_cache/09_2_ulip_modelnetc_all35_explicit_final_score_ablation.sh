...
COMMON_SCRIPT="${SCRIPT_DIR}/09_run_e4_c_a0_e1_explicit_final_score_all35_common.sh"
...
export E4_FINAL_SCORE_SWEEP_TAG="${E4_FINAL_SCORE_SWEEP_TAG:-priority_cap678_w6}"
...
run_combo() {
  ...
  echo "================================================------------"
  echo "09_2 ModelNet-C all35 explicit final-score ablation"
  ...
  echo "Result dir:"
  echo "/root/autodl-tmp/MCM-PC-2/Point-Cache/results/E4_distribution_guided_cache/09_2_${setting}_${E4_FINAL_SCORE_SWEEP_TAG}_ulip_modelnetc_all35_zs_global_local_e4_c_a0_e1_explicit_final_score_tw0p15_score_norm_manual_full_clip_manualfull_llm_dynamic_init_textdist"
  echo "================================================------------"
...
echo "============================================================"
echo "09_2 queued ModelNet-C all35 explicit final-score ablation"
echo "GPU: ${PHYSICAL_GPU}"
...
echo "============================================================"
echo "Finished 09_2 ModelNet-C all35 explicit final-score ablation queue"
echo "Combinations: ${COMBINATIONS[*]}"
echo "Final score weight count: ${#FINAL_SCORE_WEIGHTS[@]}"
echo "============================================================"
