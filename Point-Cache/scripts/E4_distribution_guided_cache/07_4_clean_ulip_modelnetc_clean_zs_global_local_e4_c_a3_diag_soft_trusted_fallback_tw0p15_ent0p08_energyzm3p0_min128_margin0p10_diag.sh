...
EXP_ID="07_4_clean_ulip_modelnetc_clean_zs_global_local_e4_c_a3_diag_soft_trusted_fallback_tw0p15_ent0p08_energyzm3p0_min128_margin0p10_diag"
...
export E4_SOFT_TRUSTED_MARGIN="${E4_SOFT_TRUSTED_MARGIN:-0.10}"
...
echo "============================================================"
echo "07_4 clean ModelNet-C A3 diagnostic soft trusted fallback run"
echo "EXP_ID: ${EXP_ID}"
echo "RUNNER: ${RUNNER}"
...
python "${RUNNER}" \
  ...
  --baseline-method-full "07_4 clean: E4-C-A3 diagnostic soft trusted fallback tw0.15 entropy<=0.08 energy_z<=-3.0 min_count=128 margin=0.10 diag=sample_energy+replacement_snapshot on modelnet_c clean.h5" \
