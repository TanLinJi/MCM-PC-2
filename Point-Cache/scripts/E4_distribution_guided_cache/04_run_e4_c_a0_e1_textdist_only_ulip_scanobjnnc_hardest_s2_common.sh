...
if [[ "$#" -lt 4 ]]; then
  echo "Usage: bash 04_run_e4_c_a0_e1_textdist_only_ulip_scanobjnnc_hardest_s2_common.sh EXP_ID TEXT_WEIGHT PURPOSE GPU"
  exit 1
fi
...
RUNNER="runners/E4_distribution_guided_cache/run_e4_c_a0_e1_textdist_only_ulip_scanobjnnc_hardest_s2_accepted_history_text_visual_distribution_guided_gpa.py"
...
echo "============================================================"
echo "E4-C-A0+E1-textdist-only ScanObjNN-C hardest severity=2"
echo "EXP_ID: ${EXP_ID}"
echo "RUNNER: ${RUNNER}"
