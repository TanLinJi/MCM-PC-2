...
export E4_GPA_GLOBAL_PRIOR="${E4_GPA_GLOBAL_PRIOR:-${GPA_GLOBAL_PRIOR:-uniform}}"
export E4_GPA_GLOBAL_EPS="${E4_GPA_GLOBAL_EPS:-${GPA_GLOBAL_EPS:-1e-12}}"
export E4_GPA_GLOBAL_BETA="${E4_GPA_GLOBAL_BETA:-${GPA_GLOBAL_BETA:-}}"
export E4_GPA_GLOBAL_PRIOR_GAMMAS="${E4_GPA_GLOBAL_PRIOR_GAMMAS:-0.1,0.25,0.5}"
export E4_GPA_GLOBAL_ODDS_GAMMAS="${E4_GPA_GLOBAL_ODDS_GAMMAS:-${E4_GPA_GLOBAL_GAMMAS:-${GPA_GLOBAL_GAMMAS:-0.05,0.1,0.25}}}"

mkdir -p "${WANDB_DIR}"

echo "============================================================"
echo "E4-C-A0-c3 Z-score Accepted-History Text-Visual GPA Cache One-vs-Rest GPA Global Log-Odds"
echo "EXP_ID: ${EXP_ID}"
echo "RUNNER: ${RUNNER}"
...
echo "E4_GPA_GLOBAL_PRIOR: ${E4_GPA_GLOBAL_PRIOR}"
echo "E4_GPA_GLOBAL_EPS: ${E4_GPA_GLOBAL_EPS}"
echo "E4_GPA_GLOBAL_BETA: ${E4_GPA_GLOBAL_BETA:-positive.beta}"
echo "E4_GPA_GLOBAL_PRIOR_GAMMAS: ${E4_GPA_GLOBAL_PRIOR_GAMMAS}"
echo "E4_GPA_GLOBAL_ODDS_GAMMAS: ${E4_GPA_GLOBAL_ODDS_GAMMAS}"
echo "============================================================"
