...
EXP_NAME="e0_tpe_v2_median_zs_modelnetc_severity2_corruptions"
...
run_one() {
  ...
  echo "[E0-TPE-v2-median-ZS] Start: ${corruption} on GPU ${gpu_id}"
  ...
  if [[ "${exit_code}" -ne 0 ]]; then
    ...
    echo "[E0-TPE-v2-median-ZS] Failed: ${corruption}. See ${log_file}"
    return 0
  fi
  ...
  echo "[E0-TPE-v2-median-ZS] Finished: ${corruption} | GPU ${gpu_id} | Status ${status} | Accuracy ${acc}"
}
...
echo
echo "[E0-TPE-v2-median-ZS] All done."
