...
PROMPT_COUNT="15"
LLM_PROMPT_MODE_VALUE="image12_pointcloud3"
DEFAULT_PROMPT_FILE="modelnet_c_llm_descriptions_deepseek_v4pro_15_prompts_12_image_3_pointcloud.json"
DEFAULT_EXP_ID="E1_22_modelnet_c_severity2_15_prompts_12_image_3_pointcloud_manual75_llm25"
...
if [[ "${USE_DEFAULT_PROMPTS}" == "1" ]]; then
  ...
  PROMPT_CACHE_DIR_VALUE="${E1_GENERATED_PROMPT_DIR:-llm/generated/E1_22_15_prompts_12_image_3_pointcloud_${GENERATED_TAG}}"
  PROMPT_CACHE_FILE_VALUE="${E1_GENERATED_PROMPT_FILE:-${DEFAULT_PROMPT_FILE}}"

  echo "============================================================"
  echo "E1_22 severity2 diagnostic prompt generation mode"
...
bash "${SCRIPT_DIR}/common/run_modelnet_c_fusion.sh" \
  ...
  "${LLM_PROMPT_MODE_VALUE}" \
  "${PROMPT_CACHE_FILE_VALUE}" \
  "ModelNet-C severity2 prompt composition diagnostic, 15 prompts = 12 image + 3 pointcloud, manual75_llm25" \
  "${PHYSICAL_GPU}"
