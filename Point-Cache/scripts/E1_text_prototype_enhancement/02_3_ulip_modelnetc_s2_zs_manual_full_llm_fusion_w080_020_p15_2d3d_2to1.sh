...
LLM_PROMPT_MODE=multiview_2d3d_2to1 \
bash "${SCRIPT_DIR}/01_run_ulip_modelnetc_s2_zs_fusion_weight_ablation_common.sh" \
  "02_3_ulip_modelnetc_s2_zs_manual_full_llm_fusion_w080_020_p15_2d3d_2to1" \
  "0.80" \
  "0.20" \
  "15 条 LLM 描述，2D:3D = 2:1，manual_full:LLM = 0.80:0.20" \
  "${1:-0}"
