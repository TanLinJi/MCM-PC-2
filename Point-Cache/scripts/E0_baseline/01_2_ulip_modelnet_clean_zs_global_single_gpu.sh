# 本脚本用于复现 Point-Cache baseline 实验 01_2：ULIP 在 ModelNet clean 上的 Zero-shot + Global Cache 推理。
#!/usr/bin/env bash
set -euo pipefail

PROJECT_ROOT="/root/autodl-tmp/MCM-PC-2"
PC_ROOT="${PROJECT_ROOT}/Point-Cache"
EXP_ID="01_2_ulip_modelnet_clean_zs_global"
METHOD="zs_global"
METHOD_FULL="Zero-shot + Global Cache"
