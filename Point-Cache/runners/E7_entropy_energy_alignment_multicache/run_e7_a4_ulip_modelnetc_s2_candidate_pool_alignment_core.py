#!/usr/bin/env python
"""
E7-A4 runner: ULIP + ModelNet-C severity=2, candidate-pool alignment-core cache.
...
2. 路由到 E7-A4 的候选池-对齐核心缓存模型 run_test_tda；
...
from runners.E7_entropy_energy_alignment_multicache.model_e7_a4_candidate_pool_alignment_core import (
    run_test_tda as run_e7_a4_candidate_pool_alignment_core,
)
    ...
    with log_file.open("w") as lf:
        ...
        with redirect_stdout(Tee(sys.__stdout__, lf)), redirect_stderr(Tee(sys.__stderr__, lf)):
            ...
            try:
                ...
                print(f"[E7-A4] clip (final classifier) prompt source: {args.prompt_source}")
                print(f"[E7-A4] text distribution prompt source: {args.e7_text_dist_prompt_source}")
                print(f"[E7-A4] text_dist classes: {len(text_dist)}")
                ...
                if baseline_method == "zs":
                    ...
                    acc = run_e7_a4_candidate_pool_alignment_core(
...
def main():
    ...
    args.e7_variant = "E7-A4-candidate-pool-alignment-core"
    ...
    with redirect_stdout(Tee(sys.__stdout__, init_log_buffer)), redirect_stderr(Tee(sys.__stderr__, init_log_buffer)):
        print("============================================================")
        print("E7-A4 ULIP ModelNet-C severity=2 Candidate-Pool Alignment-Core runner")
        ...
        print("Variant: E7-A4 candidate-pool alignment-core cache (global feature only, no local cache)")
