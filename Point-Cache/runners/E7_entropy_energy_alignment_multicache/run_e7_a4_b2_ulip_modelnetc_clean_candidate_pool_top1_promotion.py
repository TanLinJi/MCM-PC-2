...
from runners.E7_entropy_energy_alignment_multicache.model_e7_a4_b2_candidate_pool_top1_promotion import (  # noqa: E402
    run_test_tda as run_e7_a4_b2_top1_promotion,
)
from runners.E7_entropy_energy_alignment_multicache.run_e7_a4_b2_ulip_modelnetc_s2_candidate_pool_top1_promotion import (  # noqa: E402
    Tee,
    parse_args,
    make_wandb_run_name,
    ...
    with log_file.open("w") as lf:
        ...
        with redirect_stdout(Tee(sys.__stdout__, lf)), redirect_stderr(Tee(sys.__stderr__, lf)):
            ...
            try:
                ...
                print("[E7-A4-B2-clean] clip prompt source:", args.prompt_source)
                print("[E7-A4-B2-clean] text distribution prompt source:", args.e7_text_dist_prompt_source)
                print("[E7-A4-B2-clean] text_dist classes:", len(text_dist))
                ...
                if baseline_method == "zs":
                    ...
                    acc = run_e7_a4_b2_top1_promotion(
                        args,
                        cfg["positive"],
                        cfg["negative"],
                        test_loader,
...
def main():
    ...
    args.e7_variant = "E7-A4-B2-candidate-pool-top1-promotion-clean"
    ...
    with redirect_stdout(Tee(sys.__stdout__, init_log_buffer)), redirect_stderr(Tee(sys.__stderr__, init_log_buffer)):
        print("============================================================")
        print("E7-A4-B2 Candidate-Pool Top1 Promotion on clean ModelNet-C runner")
        ...
        print("Variant: E7-A4-B2 candidate-pool top1 promotion clean (global feature only, no local cache)")
