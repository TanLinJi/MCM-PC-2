...
from runners.E7_entropy_energy_alignment_multicache.model_e7_b3_diag_0292_textdist_cache_branch_diagnostics import (
    ...
    with log_file.open("w") as lf:
        ...
        with redirect_stdout(Tee(sys.__stdout__, lf)), redirect_stderr(Tee(sys.__stderr__, lf)):
            ...
            try:
                ...
                print(f"[E7-B3-Diag-02_9_2] clip prompt source: {args.prompt_source}")
                print(f"[E7-B3-Diag-02_9_2] text distribution prompt source: {args.e4_text_dist_prompt_source}")
                print(f"[E7-B3-Diag-02_9_2] text_dist classes: {len(text_dist)}")
...
def main():
    ...
    args.e4_variant = "E7-B3-Diag-02_9_2-cache-branch-diagnostics"
    ...
    with redirect_stdout(Tee(sys.__stdout__, init_log_buffer)), redirect_stderr(Tee(sys.__stderr__, init_log_buffer)):
        print("============================================================")
        print("E7-B3-Diag-02_9_2 ULIP ModelNet-C severity=2 cache-branch diagnostics runner")
        ...
        print("Variant: E7-B3-Diag-02_9_2 cache-branch diagnostics, prediction unchanged")
