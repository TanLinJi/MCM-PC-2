...
from runners.E5_adapt_inspired_gaussian_alignment_cache.model_e5_a0_a1_adapt_gda_diagnostics import (
    ...
    with log_file.open("w") as lf:
        ...
        with redirect_stdout(Tee(sys.__stdout__, lf)), redirect_stderr(Tee(sys.__stderr__, lf)):
            ...
            try:
                ...
                print(f"[E5-A0/A1] baseline clip prompt source: {args.prompt_source}")
                print(f"[E5-A0/A1] E4 text distribution prompt source: {args.e4_text_dist_prompt_source}")
                print(f"[E5-A0/A1] text_dist classes: {len(text_dist)}")
...
def main():
    ...
    args.e5_variant = "E5-A0/A1-adapt-inspired-gda-diagnostics"
    ...
    args.e5_gda_alpha = float(os.environ.get("E5_GDA_ALPHA", "0.9"))
    args.e5_gda_min_total = int(os.environ.get("E5_GDA_MIN_TOTAL", "8"))
    args.e5_gda_min_classes = int(os.environ.get("E5_GDA_MIN_CLASSES", "2"))
    args.e5_gda_norm_eps = float(os.environ.get("E5_GDA_NORM_EPS", "1e-6"))
    args.e5_gda_norm_clip = float(os.environ.get("E5_GDA_NORM_CLIP", "3.0"))
    args.e5_save_sample_diagnostics = os.environ.get("E5_SAVE_SAMPLE_DIAGNOSTICS", "1")
    args.e5_gda_override_thresholds = os.environ.get("E5_GDA_OVERRIDE_THRESHOLDS", "0.5,0.75,1.0,1.25,1.5,2.0")
    ...
    with redirect_stdout(Tee(sys.__stdout__, init_log_buffer)), redirect_stderr(Tee(sys.__stderr__, init_log_buffer)):
        print("============================================================")
        print("E5-A0/A1 ULIP ModelNet-C severity=2 ADAPT-inspired StatsBank + shared-covariance GDA diagnostics runner")
        ...
        print("Variant: E5-A0/A1 diagnostics over E4-C-A0+E1-textdist-only baseline")
        ...
        print(f"E5_GDA_ALPHA: {args.e5_gda_alpha}")
        print(f"E5_GDA_MIN_TOTAL: {args.e5_gda_min_total}")
        print(f"E5_GDA_MIN_CLASSES: {args.e5_gda_min_classes}")
        print(f"E5_GDA_NORM_EPS: {args.e5_gda_norm_eps}")
        print(f"E5_GDA_NORM_CLIP: {args.e5_gda_norm_clip}")
        print(f"E5_SAVE_SAMPLE_DIAGNOSTICS: {args.e5_save_sample_diagnostics}")
        print(f"E5_GDA_OVERRIDE_THRESHOLDS: {args.e5_gda_override_thresholds}")
