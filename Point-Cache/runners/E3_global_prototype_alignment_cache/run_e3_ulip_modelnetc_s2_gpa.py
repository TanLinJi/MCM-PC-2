...
from runners.E3_global_prototype_alignment_cache.model_with_hierarchical_caches_gpa import run_test_tda as run_hierarchical_cache
...
def main():
    ...
    with redirect_stdout(Tee(sys.__stdout__, init_log_buffer)), redirect_stderr(Tee(sys.__stderr__, init_log_buffer)):
        print("============================================================")
        print("E3 ULIP ModelNet-C severity=2 Global Prototype-Alignment Cache runner")
