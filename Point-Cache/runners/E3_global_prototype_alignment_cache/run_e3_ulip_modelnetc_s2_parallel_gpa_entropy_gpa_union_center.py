...
from runners.E3_global_prototype_alignment_cache.model_with_hierarchical_caches_parallel_gpa_entropy_gpa_union_center import run_test_tda as run_hierarchical_cache
...
def main():
    ...
    with redirect_stdout(Tee(sys.__stdout__, init_log_buffer)), redirect_stderr(Tee(sys.__stderr__, init_log_buffer)):
        print("============================================================")
        print("E3-V2 ULIP ModelNet-C severity=2 Parallel GPA Cache Entropy+GPA union center runner")
