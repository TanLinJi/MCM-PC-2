#!/usr/bin/env python
# 本 runner 用于在单个 Python 进程中复现 ULIP-2 × ScanObjNN-C hardest 全 35 个损坏设置的一种 baseline 方法，避免 35 次重复加载模型。
import argparse
import csv
import gc
import io
...
def main():
    ...
    with redirect_stdout(Tee(sys.__stdout__, init_log_buffer)), redirect_stderr(Tee(sys.__stderr__, init_log_buffer)):
        print("============================================================")
        print("Optimized ULIP-2 ScanObjNN-C hardest all35 baseline runner")
