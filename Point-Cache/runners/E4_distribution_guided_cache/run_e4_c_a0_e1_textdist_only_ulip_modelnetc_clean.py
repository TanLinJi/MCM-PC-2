...
from runners.E4_distribution_guided_cache.model_e4_c_accepted_history_text_visual_distribution_guided_gpa import (  # noqa: E402
    ...
    with log_file.open("w") as lf:
        ...
        with redirect_stdout(Tee(sys.__stdout__, lf)), redirect_stderr(Tee(sys.__stderr__, lf)):
            ...
            try:
                ...
                print("[E4-C-A0+E1-textdist-clean] clip prompt source:", args.prompt_source)
                print("[E4-C-A0+E1-textdist-clean] text distribution prompt source:", args.e4_text_dist_prompt_source)
                print("[E4-C-A0+E1-textdist-clean] text_dist classes:", len(text_dist))
...
def main():
    ...
    args.e4_variant = "E4-C-A0+E1-textdist-only-clean"
    ...
    with redirect_stdout(Tee(sys.__stdout__, init_log_buffer)), redirect_stderr(Tee(sys.__stderr__, init_log_buffer)):
        print("============================================================")
        print("E4-C-A0+E1-textdist-only 02_9_2 on clean ModelNet-C runner")
        ...
        print("Variant: E4-C-A0+E1-textdist-only clean")
