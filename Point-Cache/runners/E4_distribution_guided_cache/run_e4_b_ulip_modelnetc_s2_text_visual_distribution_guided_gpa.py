...
from runners.E4_distribution_guided_cache.model_e4_b_text_visual_distribution_guided_gpa import run_test_tda as run_hierarchical_cache
    ...
    with log_file.open("w") as lf:
        ...
        with redirect_stdout(Tee(sys.__stdout__, lf)), redirect_stderr(Tee(sys.__stderr__, lf)):
            ...
            try:
                ...
                print(f"[E4-B] text_dist classes: {len(text_dist)}")
...
def main():
    ...
    with redirect_stdout(Tee(sys.__stdout__, init_log_buffer)), redirect_stderr(Tee(sys.__stderr__, init_log_buffer)):
        print("============================================================")
        print("E4-B ULIP ModelNet-C severity=2 Text-Visual Distribution-Guided GPA Cache runner")
