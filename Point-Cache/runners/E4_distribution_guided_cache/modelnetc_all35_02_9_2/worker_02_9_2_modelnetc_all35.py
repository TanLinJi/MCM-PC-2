...
from runners.E4_distribution_guided_cache.run_e4_c_a0_e1_textdist_only_ulip_modelnetc_s2_accepted_history_text_visual_distribution_guided_gpa import (
    Tee,
    append_summary_row,
    run_one_corruption,
...
def main():
    ...
    wandb_dir = run_dir / f"wandb_worker{worker_id}"
    ...
    with redirect_stdout(Tee(sys.__stdout__, init_log_buffer)), redirect_stderr(Tee(sys.__stderr__, init_log_buffer)):
        print("============================================================")
        print("02-9-2 all35 worker: E4-C-A0+E1-textdist-only on ModelNet-C")
