...
from runners.E4_distribution_guided_cache.model_e4_c_a3_diag_soft_trusted_fallback_accepted_history_text_visual_distribution_guided_gpa import run_test_tda as run_hierarchical_cache
    ...
    with log_file.open("w") as lf:
        ...
        with redirect_stdout(Tee(sys.__stdout__, lf)), redirect_stderr(Tee(sys.__stderr__, lf)):
            ...
            try:
                ...
                print(f"[E4-C-A3 diagnostic soft trusted fallback] clip prompt source: {args.prompt_source}")
                print(f"[E4-C-A3 diagnostic soft trusted fallback] text distribution prompt source: {args.e4_text_dist_prompt_source}")
                print(f"[E4-C-A3] text_dist classes: {len(text_dist)}")
...
def main():
    ...
    args.e4_variant = "E4-C-A3-diagnostic-soft-trusted-fallback"
    ...
    with redirect_stdout(Tee(sys.__stdout__, init_log_buffer)), redirect_stderr(Tee(sys.__stderr__, init_log_buffer)):
        print("============================================================")
        print("E4-C-A3 diagnostic soft trusted fallback ULIP ModelNet-C severity=2 runner")
        ...
        print("Variant: E4-C-A3 diagnostic soft trusted fallback")
