...
from runners.E4_distribution_guided_cache.model_e4_a_visual_distribution_guided_gpa import run_test_tda as run_hierarchical_cache
...
def main():
    ...
    with redirect_stdout(Tee(sys.__stdout__, init_log_buffer)), redirect_stderr(Tee(sys.__stderr__, init_log_buffer)):
        print("============================================================")
        print("E4-A ULIP ModelNet-C severity=2 Distribution-Guided GPA Cache runner")
