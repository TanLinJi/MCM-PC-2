...
def build_clip_weights_once(args, clip_model, clip_weights_state, classnames, template):
    if clip_weights_state["clip_weights"] is None:
        ...
        if list(classnames) != clip_weights_state["classnames"]:
            raise RuntimeError(
                "Classnames changed inside ScanObjNN-C hardest severity=4 loop. "
...
def main():
    ...
    with redirect_stdout(Tee(sys.__stdout__, init_log_buffer)), redirect_stderr(Tee(sys.__stderr__, init_log_buffer)):
        print("============================================================")
        print("E4-C-A0+E1-textdist ULIP ScanObjNN-C hardest severity=4 Accepted-History Text-Visual Distribution-Guided GPA Cache runner")
        ...
        print("Variant: E4-C-A0+E1-textdist-only")
        ...
        print("Model will be loaded once, then 7 severity=4 cor_type values will be evaluated.")
        print("============================================================")
    ...
    print()
    print("============================================================")
    print(f"All 7 severity=4 runs finished: {exp_id}")
