...
from runners.E4_distribution_guided_cache.model_e4_c_a0_e1_protective_soft_rejection_gpa import run_test_tda as run_hierarchical_cache
...
def main():
    ...
    args.e4_variant = "E4-02_11-protective-soft-rejection-gpa"
    ...
    with redirect_stdout(Tee(sys.__stdout__, init_log_buffer)), redirect_stderr(Tee(sys.__stderr__, init_log_buffer)):
        print("============================================================")
        print("E4-C-A0+E1-textdist ULIP ModelNet-C severity=2 Accepted-History Text-Visual Distribution-Guided GPA Cache runner")
