...
from runners.E4_distribution_guided_cache.model_02_18_1_d_vmf0_directional_stats_diag import (
    ...
    with log_file.open("w") as lf:
        ...
        with redirect_stdout(Tee(sys.__stdout__, lf)), redirect_stderr(Tee(sys.__stderr__, lf)):
            ...
            try:
                ...
                print(f"[02_18_1 D-vMF-0] clip prompt source: {args.prompt_source}")
                print(f"[02_18_1 D-vMF-0] text distribution prompt source: {args.e4_text_dist_prompt_source}")
                print(f"[02_18_1 D-vMF-0] text_dist classes: {len(text_dist)}")
...
def main():
    ...
    args.e4_variant = "02_18_1-D-vMF-0-directional-stats-diagnostics"
    ...
    with redirect_stdout(Tee(sys.__stdout__, init_log_buffer)), redirect_stderr(Tee(sys.__stderr__, init_log_buffer)):
        print("============================================================")
        print("02_18_1 D-vMF-0 ULIP ModelNet-C severity=2 directional diagnostics runner")
        ...
        print("Variant: D-vMF-0 directional statistics diagnostics, prediction unchanged")
