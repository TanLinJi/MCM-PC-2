"""
E4-C: Accepted-History Text-Visual Distribution-Guided GPA Cache for Point-Cache.
...
GPA_VARIANT_NAME = "E4-C-accepted-history-text-visual-distribution-guided-gpa-cache"
