...
from runners.E4_distribution_guided_cache.model_e4_c_a0_e1_decoupled_cache_capacity import run_test_tda as run_hierarchical_cache
...
def main():
    ...
    args.e4_variant = "09_1-E4-C-A0+E1-textdist-only-decoupled-cache-capacity"
    ...
    with redirect_stdout(Tee(sys.__stdout__, init_log_buffer)), redirect_stderr(Tee(sys.__stderr__, init_log_buffer)):
        print("============================================================")
        print("09_1 E4-C-A0+E1-textdist ULIP ModelNet-C severity=2 Decoupled Cache-Capacity runner")
        ...
        print("Variant: 09_1-E4-C-A0+E1-textdist-only-decoupled-cache-capacity")
