...
from runners.E4_distribution_guided_cache.model_e4_c_a0_c2_prior_corrected_gpa_global_logits import (
    get_formula_labels,
    ...
    with log_file.open("w") as lf:
        ...
        with redirect_stdout(Tee(sys.__stdout__, lf)), redirect_stderr(Tee(sys.__stderr__, lf)):
            ...
            try:
                ...
                print(f"[E4-C-A0-c2] text_dist classes: {len(text_dist)}")
...
def main():
    ...
    with redirect_stdout(Tee(sys.__stdout__, init_log_buffer)), redirect_stderr(Tee(sys.__stderr__, init_log_buffer)):
        print("============================================================")
        print("E4-C-A0-c2 ULIP ModelNet-C severity=2 Z-score Accepted-History Text-Visual GPA Cache Prior-Corrected GPA Global Logits runner")
        ...
        print(f"E4_GPA_GLOBAL_GAMMAS: {os.environ.get('E4_GPA_GLOBAL_GAMMAS', os.environ.get('GPA_GLOBAL_GAMMAS', '0.1,0.25,0.5'))}")
