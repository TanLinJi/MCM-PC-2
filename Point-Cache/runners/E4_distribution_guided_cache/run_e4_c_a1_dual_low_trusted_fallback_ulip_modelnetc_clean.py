...
from runners.E4_distribution_guided_cache.model_e4_c_a1_dual_low_trusted_fallback_accepted_history_text_visual_distribution_guided_gpa import (  # noqa: E402
    run_test_tda as run_hierarchical_cache,
)
from runners.E4_distribution_guided_cache.run_e4_c_a1_dual_low_trusted_fallback_ulip_modelnetc_s2_accepted_history_text_visual_distribution_guided_gpa import (  # noqa: E402
    Tee,
    parse_args,
    make_wandb_run_name,
    ...
    with log_file.open("w") as lf:
        ...
        with redirect_stdout(Tee(sys.__stdout__, lf)), redirect_stderr(Tee(sys.__stderr__, lf)):
            ...
            try:
                ...
                print("[E4-C-A1 dual-low trusted fallback clean] clip prompt source:", args.prompt_source)
                print("[E4-C-A1 dual-low trusted fallback clean] text distribution prompt source:", args.e4_text_dist_prompt_source)
                print("[E4-C-A1 dual-low trusted fallback clean] text_dist classes:", len(text_dist))
...
def main():
    ...
    args.e4_variant = "E4-C-A1-dual-low-trusted-fallback-clean"
    ...
    with redirect_stdout(Tee(sys.__stdout__, init_log_buffer)), redirect_stderr(Tee(sys.__stderr__, init_log_buffer)):
        print("============================================================")
        print("E4-C-A1 dual-low trusted fallback on clean ModelNet-C runner")
        ...
        print("Variant: E4-C-A1 dual-low trusted fallback clean")
