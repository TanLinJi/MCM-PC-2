...
tail -n +2 results/E0_baseline/22_1_openshape_modelnetc_corruptions_all35_zs/summary.csv | wc -l

tail -n +2 results/E0_baseline/22_1_openshape_modelnetc_corruptions_all35_zs/summary.csv | cut -d',' -f15 | sort -u | wc -l

find results/E0_baseline/22_1_openshape_modelnetc_corruptions_all35_zs/logs -maxdepth 1 -name '*.log' | wc -l

22_2：

cd /root/autodl-tmp/MCM-PC-2/Point-Cache

tail -n +2 results/E0_baseline/22_2_openshape_modelnetc_corruptions_all35_zs_global/summary.csv | wc -l

tail -n +2 results/E0_baseline/22_2_openshape_modelnetc_corruptions_all35_zs_global/summary.csv | cut -d',' -f15 | sort -u | wc -l

find results/E0_baseline/22_2_openshape_modelnetc_corruptions_all35_zs_global/logs -maxdepth 1 -name '*.log' | wc -l

22_3：

cd /root/autodl-tmp/MCM-PC-2/Point-Cache

tail -n +2 results/E0_baseline/22_3_openshape_modelnetc_corruptions_all35_zs_global_local/summary.csv | wc -l

tail -n +2 results/E0_baseline/22_3_openshape_modelnetc_corruptions_all35_zs_global_local/summary.csv | cut -d',' -f15 | sort -u | wc -l

find results/E0_baseline/22_3_openshape_modelnetc_corruptions_all35_zs_global_local/logs -maxdepth 1 -name '*.log' | wc -l
