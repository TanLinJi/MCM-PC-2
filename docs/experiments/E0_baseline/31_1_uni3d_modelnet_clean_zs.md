...
Point-Cache/results/E0_baseline/31_1_uni3d_modelnet_clean_zs/
...
tail -n +2 results/E0_baseline/31_1_uni3d_modelnet_clean_zs/summary.csv | cut -d',' -f13 | sort | uniq -c

cat results/E0_baseline/31_1_uni3d_modelnet_clean_zs/summary.csv
