...
Point-Cache/results/E0_baseline/21_2_openshape_modelnet_clean_zs_global/
...
tail -n +2 results/E0_baseline/21_2_openshape_modelnet_clean_zs_global/summary.csv | cut -d',' -f13 | sort | uniq -c

cat results/E0_baseline/21_2_openshape_modelnet_clean_zs_global/summary.csv
