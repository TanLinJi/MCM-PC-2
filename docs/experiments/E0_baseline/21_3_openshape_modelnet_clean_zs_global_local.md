...
Point-Cache/results/E0_baseline/21_3_openshape_modelnet_clean_zs_global_local/
...
tail -n +2 results/E0_baseline/21_3_openshape_modelnet_clean_zs_global_local/summary.csv | cut -d',' -f13 | sort | uniq -c

cat results/E0_baseline/21_3_openshape_modelnet_clean_zs_global_local/summary.csv
