...
| 结果目录 | Point-Cache/results/E0_baseline/02_1_ulip_modelnetc_corruptions_all35_zs/ |
...
Point-Cache/results/E0_baseline/02_1_ulip_modelnetc_corruptions_all35_zs/
...
tail -n +2 results/E0_baseline/02_1_ulip_modelnetc_corruptions_all35_zs/summary.csv | cut -d',' -f13 | sort | uniq -c
